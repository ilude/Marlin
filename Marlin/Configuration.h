 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.19,80.19,4000,106.23}
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT ((X_BED_SIZE) / 8)    // X point for Z homing when homing all axes (G28).
  #define Z_SAFE_HOMING_Y_POINT ((Y_BED_SIZE) / 8)    // Y point for Z homing when homing all axes (G28).
#endif
